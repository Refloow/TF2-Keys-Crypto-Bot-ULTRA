...
<img width="2116" height="1131" alt="image" src="https://github.com/user-attachments/assets/11531f6c-fef8-4c39-8775-1306c5e2a732" />
(dark mode backend admin panel overview)
...
<img width="217" height="150" alt="image" src="https://github.com/user-attachments/assets/93e3ae9f-6a15-4815-a55f-ab23f2517285" />
...
<img width="2133" height="1108" alt="image" src="https://github.com/user-attachments/assets/9ce6d123-5724-48d0-92c6-652d3d5b8f52" />
(keep in mind, data shown in the photo is test data meant to populate charts combined with data created throught testing. It is certainly inacurate. Its sole purpose is to populate charts for the purpose of the showcase



<img width="1944" height="1018" alt="image" src="https://github.com/user-attachments/assets/abced425-35c2-47c9-8fba-4a845190afba" />
(all of the charts can be expanded, changed display from daily to monthly displays of data and they can also render data in multiple formats)
<img width="1949" height="1002" alt="image" src="https://github.com/user-attachments/assets/ba53e7d2-7d92-4e56-9b50-65988cb7c70e" />
(example of the same chart with different styling selected and comparesons enabled)
...
<img width="2127" height="1096" alt="image" src="https://github.com/user-attachments/assets/0a84a65c-24bb-4448-b0e5-5f294ac31752" />
(light mode backend admin panel overview)
...
* **Dynamic Network Handling:** Automatically supports all available Binance withdrawal networks, validates addresses per-network, shows examples of addresses, and displays real-time network status to users.
  <img width="1073" height="751" alt="image" src="https://github.com/user-attachments/assets/f9880f0d-5662-4fe1-90e4-cb5ed85a4cf1" />
...
* **Custom Playing Message:** Display real-time stock and pricing information directly in the bot's "Now Playing" status on Steam.
  <img width="1032" height="528" alt="image" src="https://github.com/user-attachments/assets/97cf088b-5a1d-4ce7-aade-a9d2e0aa4834" />


### User & Admin Experience

* **Full Command Suite:** A wide variety of commands for users to check prices, their history, and more.
<img width="863" height="826" alt="image" src="https://github.com/user-attachments/assets/97cbc985-8586-42dc-93c4-3ce416bf7052" />
